...
#define MSMFB_SET_GAMMA_MODE          _IOW(MSMFB_IOCTL_MAGIC, 169, unsigned int)
#define MSMFB_SET_CE_MODE             _IOW(MSMFB_IOCTL_MAGIC, 170, unsigned int)
#define MSMFB_SET_SHARPNESS_MODE      _IOW(MSMFB_IOCTL_MAGIC, 171, unsigned int)
#define MSMFB_SET_CABC_MODE           _IOW(MSMFB_IOCTL_MAGIC, 172, unsigned int)
#define MSMFB_SET_FINAL_VCOM           _IOW(MSMFB_IOCTL_MAGIC, 173, unsigned int)
