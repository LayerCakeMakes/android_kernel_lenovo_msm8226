...
#ifndef RTC_WKALM_SUPPORT
static long power_on_alarm;
#else
static long power_on_alarm = 0;
#endif
...
int alarm_set_rtc(struct timespec new_time)
{
    ...
    #else
    printk("andypan alarm_set_rtc %ld %ld - rtc %02d:%02d:%02d %02d/%02d/%04d\n",
        new_time.tv_sec, new_time.tv_nsec,
        rtc_new_rtc_time.tm_hour, rtc_new_rtc_time.tm_min,
        rtc_new_rtc_time.tm_sec, rtc_new_rtc_time.tm_mon + 1,
        rtc_new_rtc_time.tm_mday,
...
void alarm_set_real_rtc(int alarm_type,  struct timespec new_alarm_time)
{
        ...
        printk("andypan alarm_set_real_rtc: %d, %ld.%ld\n", alarm_type,
