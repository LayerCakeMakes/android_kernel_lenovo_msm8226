...
extern void bq24196_otg_notify_power_supply_type(enum power_supply_type type);
#endif
...
#ifdef CONFIG_BATTERY_BQ24196
	dev_err(motg->phy.dev,"bq24196 %s,usb_chg_type:%d, power_supply_type=%d \n",__func__,motg->chg_type, charger_type);
	bq24196_otg_notify_power_supply_type(charger_type);
#endif
	return 0;
}
...
//#ifdef CONFIG_BATTERY_BQ24196
//	dev_err(motg->phy.dev,"bq24196 %s,chg_type:%d\n",__func__,motg->chg_type);
//	bq24196_otg_notify_power_supply_type(motg->chg_type);
//#endif
	/*
...
extern void bq24196_otg_power(int);
