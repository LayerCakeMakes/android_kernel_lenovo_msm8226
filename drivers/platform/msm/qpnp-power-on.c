...
/*Lenovo SW zhangxt4 add log for PM, pon_type(type of PON/RESET source), 20131022*/
	printk(KERN_INFO "%s(), type of PON/RESET source, pon_type=%d\n", __func__, pon_type);
...
/*Lenovo SW zhangxt4 add log for PM, 20131023*/
	printk(KERN_INFO "%s(), cfg->pon_type=%d, cfg->key_code=%d\n", __func__, cfg->pon_type, cfg->key_code);
