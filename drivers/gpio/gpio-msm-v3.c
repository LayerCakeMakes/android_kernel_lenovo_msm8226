...
{
	unsigned flags;
/*Lenovo sw zhangxt4 modify begin, porting from yangjq*/
...
static unsigned before_sleep_fetched = true; //Initialize it by zhangxt4, fix that tlmm_before_sleep doesn't work for first use.
