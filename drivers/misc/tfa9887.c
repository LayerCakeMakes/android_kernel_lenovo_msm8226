...
static atomic_t pd_called = ATOMIC_INIT(0);
...
static struct kobj_attribute tfa9887_cal =
		__ATTR(cal, 0777, tfa9887_cal_show, tfa9887_cal_store);
...
static int eq_mode, preset_mode, srate, g_channel = 0, vol_index;
...
char config_data[] = {/* 165 */
    0x09, 0xF3, 0x33, 0x01, 0x3E, 0x66, 0x00, 0x54, 0xCD, 0x00, 0x00, 0x64, 0x00, 0x00, 0x02, 0x1A,
    ...
    0x00, 0x00, 0xFA, 0x00, 0x00, 0x01, 0x00, 0x00, 0x02, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x80, 0x00, 0x20, 0x00, 0x00, 0x00, 0x03, 0x47, 0x01, 0x47, 0xAE, 0x00, 0x19,
    0x9A, 0x00, 0x00, 0x00, 0x00, 0x0C, 0xCD, 0x02, 0x80, 0x00, 0x00, 0x00, 0x01, 0x05, 0x00, 0x00,
    0x05, 0x00, 0x00, 0x00, 0x10, 0x00, 0x07, 0xC2, 0x8F, 0x00, 0x10, 0x00, 0x08, 0x00, 0x00, 0x00,
    0x19, 0x9A, 0x00, 0x10, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x01, 0x47, 0xAE, 0x00, 0x00,
    0x40, 0x00, 0x00, 0x20, 0x19, 0x99, 0x9A, 0x00, 0x80, 0x00, 0x00, 0x00, 0x02, 0x00, 0x00, 0x30,
...
/* Contents of file Lenovo_X10_Tuning_HQ_131029.preset */
const long int Lenovo_X10_Tuning_HQ_131029_preset_size = 87;
unsigned char Lenovo_X10_Tuning_HQ_131029_preset[87] = {
    0x00, 0x00, 0x01, 0x00, 0x00, 0x64, 0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x1F, 0x40, 0x00,
    0x00, 0x00, 0x00, 0x01, 0x2C, 0x01, 0x47, 0xAE, 0x00, 0x2B, 0xB1, 0x00, 0x00, 0x9D, 0x00, 0x0D,
    0x1B, 0x01, 0x00, 0x00, 0x05, 0x00, 0x00, 0x07, 0x80, 0x00, 0x08, 0x00, 0x00, 0x08, 0x00, 0x00,
    0x05, 0x00, 0x00, 0x01, 0x80, 0x00, 0x00, 0x0C, 0xCD, 0x00, 0x40, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x01, 0x48, 0x00, 0x01, 0x48, 0x08, 0x00, 0x00, 0x07, 0xC2,
    0x8F, 0x00, 0x0C, 0xCD, 0x00, 0x00, 0x03
};

/* Contents of file Lenovo_X10_Tuning_Loud_131029.preset */
const long int Lenovo_X10_Tuning_Loud_131029_preset_size = 87;
unsigned char Lenovo_X10_Tuning_Loud_131029_preset[87] = {
    0x00, 0x00, 0x01, 0x00, 0x02, 0x58, 0x00, 0x00, 0x02, 0x00, 0x00, 0x00, 0x00, 0x1F, 0x40, 0x00,
    0x00, 0x00, 0x00, 0x01, 0x2C, 0x01, 0x47, 0xAE, 0x00, 0x2B, 0xB1, 0x00, 0x00, 0x9D, 0x00, 0x0D,
    0x1B, 0x01, 0x00, 0x00, 0x07, 0x80, 0x00, 0x11, 0x80, 0x00, 0x20, 0x00, 0x00, 0x20, 0x00, 0x00,
    0x01, 0x80, 0x00, 0x00, 0x80, 0x00, 0x00, 0x0C, 0xCD, 0x00, 0x40, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x01, 0x00, 0x00, 0x00, 0x01, 0x48, 0x00, 0x01, 0x48, 0x08, 0x00, 0x00, 0x08, 0x00,
    0x00, 0x00, 0x0C, 0xCD, 0x00, 0x00, 0x03
};

unsigned char *preset_data_default = Lenovo_X10_Tuning_HQ_131029_preset;

/* Contents of file Lenovo_X10_Speaker 1_131029.speaker */
const long int Lenovo_X10_Speaker_1_131029_speaker_size = 423;
unsigned char Lenovo_X10_Speaker_1_131029_speaker[423] = {
    
};

/* Contents of file Lenovo_X10_Speaker 2_131029.speaker */
const long int Lenovo_X10_Speaker_2_131029_speaker_size = 423;
unsigned char Lenovo_X10_Speaker_2_131029_speaker[423] = {
    
};

char *speaker_data_left = Lenovo_X10_Speaker_2_131029_speaker;
char *speaker_data_right = Lenovo_X10_Speaker_1_131029_speaker;

const long int Lenovo_X10_Tuning_HQ_131029_eq_bin_size = 180;
unsigned char Lenovo_X10_Tuning_HQ_131029_eq_bin[180] = {
    0x00, 0x00, 0x01, 0xC2, 0x0F, 0x68, 0x7D, 0xD7, 0xC0, 0x3E, 0xF2, 0x14, 0x82, 0x1B, 0xD4, 0x3E,
    0xF2, 0x14, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    ...
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x02, 0xE5, 0x68, 0x66, 0x3A, 0x17, 0x46, 0x26, 0x1D, 0xD4, 0xAD, 0xD7, 0x4C, 0x2C, 0x8B, 0x32,
    0x00, 0x00, 0x00, 0xE9, 0x9D, 0xC0, 0xEE, 0x53, 0x08, 0x2A, 0x03, 0xD0, 0x54, 0x07, 0xA0, 0x2A,
    0x03, 0xD0, 0x00, 0x00, 0x01, 0xE7, 0x14, 0x74, 0x45, 0xA8, 0x90, 0x10, 0x70, 0xDC, 0xD1, 0x7F,
    0x90, 0x31, 0x52, 0x90
};

/* Contents of file Lenovo_X10_Tuning_Loud_131029.eq.bin */
const long int Lenovo_X10_Tuning_Loud_131029_eq_bin_size = 180;
unsigned char Lenovo_X10_Tuning_Loud_131029_eq_bin[180] = {
    ,
	...
	if (tfa9887R) {
		...
		if (tfa9887R->deviceInit) {
			...
			if((checkMTPEX(tfa9887R) == 0)) {
				printk(KERN_DEBUG"tfa9887: right channel is not calibrated\n");
				calibration = 1;
	...
	if (tfa9887L) {
		...
		if (tfa9887L->deviceInit) {
			...
			if((checkMTPEX(tfa9887L) == 0)) {
				printk(KERN_DEBUG"tfa9987: left channel is not calibrated\n");
				calibration = 1;
...
int SetEq(struct tfa9887_priv *tfa9887,struct tfa9887_priv *tfa9887_byte)
{
	...
	eq_data = (preset_data_default == Lenovo_X10_Tuning_HQ_131029_preset) ? Lenovo_X10_Tuning_HQ_131029_eq_bin : Lenovo_X10_Tuning_Loud_131029_eq_bin;
...
int monoRouting(struct tfa9887_priv *tfa9887)
{
        int error;
        unsigned int value;
        if(tfa9887 == tfa9887L) {
...
int Tfa9887_Mono_Stereo_Switch(int mono)
{
	if (mono) {
		if (tfa9887R) {
			mutex_lock(&tfa9887R->lock);
			stereoRouting(tfa9887R);
			mutex_unlock(&tfa9887R->lock);
		}
		
		if (tfa9887L) {
			mutex_lock(&tfa9887L->lock);
			stereoRouting(tfa9887L);
			mutex_unlock(&tfa9887L->lock);
		}
	}
	else {
...
EXPORT_SYMBOL(Tfa9887_Mono_Stereo_Switch);

int Tfa9887_get_Channels(void)
{
	return g_channel;
}
EXPORT_SYMBOL(Tfa9887_get_Channels);

int Tfa9887_Powerdown(int powerdown)
{
	int error = 0;

	atomic_set(&pd_called, powerdown);
	if (calibration) {
		printk(KERN_DEBUG "tfa9887: in calibration process\n");
		return error;
		}

	printk(KERN_DEBUG "tfa9887: powerdown:%d\n", powerdown);
...
void reset_all_tfa9887(void)
{
}
EXPORT_SYMBOL(reset_all_tfa9887);
...
{
	ssize_t ret = count;
	extern void msm_q6_disable_mi2s_clocks(void);
	extern void msm_q6_enable_mi2s_clocks(void);
	...
	ret = strncmp(buf, "reset", my_min((sizeof("reset") - 1), count));
	if (ret == 0) {
		printk(KERN_DEBUG "tfa9887: erase all calibration data\n");
		msm_q6_enable_mi2s_clocks();
		if (tfa9887R) {
			printk(KERN_DEBUG "tfa9887: erase calibrate R channel\n");
			mutex_lock(&tfa9887R->lock);			
			coldStartup(tfa9887R, tfa9887R_byte, 48000); /* fixed rate */
			resetMtpEx(tfa9887R);
			mutex_unlock(&tfa9887R->lock);			
			}
		if (tfa9887L) {
			printk(KERN_DEBUG "tfa9887: erase calibrate L channel\n");
			mutex_lock(&tfa9887L->lock);
			coldStartup(tfa9887L, tfa9887L_byte, 48000); /* fixed rate */
			resetMtpEx(tfa9887L);
			mutex_unlock(&tfa9887L->lock);			
			}
		msm_q6_disable_mi2s_clocks();
		}
	else if (strncmp(buf, "profile_loud", my_min((sizeof("profile_loud") - 1), count)) == 0) {
		preset_data_default = Lenovo_X10_Tuning_Loud_131029_preset;
		printk(KERN_DEBUG "tfa9887: Loud profile works after chip reset\n");
		}
	else if (strncmp(buf, "profile_hq", my_min((sizeof("profile_hq") - 1), count)) == 0) {
		preset_data_default = Lenovo_X10_Tuning_HQ_131029_preset;
		printk(KERN_DEBUG "tfa9887: HQ profile works after chip reset\n");
		}
	else {
		if (strncmp(buf, "setupcal2", my_min((sizeof("setupcal2") - 1), count)) == 0) {
			buf += sizeof("setupcal2");
			printk(KERN_DEBUG "tfa9887: 2nd cal:%d\n", calibration);
			if (calibration) {
				int i = 0;
				while (i++ < 6) printk(KERN_DEBUG "tfa9887: buf[%d]:%08X", i, buf[i]);
				printk(KERN_DEBUG "\n");
				printk(KERN_DEBUG "tfa9887: start 2nd calibration\n");
				msm_q6_enable_mi2s_clocks();
				msleep(200);
				recalibration = 1;
				memcpy(&speaker_data_right[420],buf,3);
				recalibrate(tfa9887R, tfa9887R_byte, 48000);
				memcpy(&speaker_data_left[420],buf + 3,3);
				recalibrate(tfa9887L, tfa9887L_byte, 48000);
				recalibration = 0;
				calibration = 0;
				printk(KERN_DEBUG "tfa9887: 2nd calibration done\n");
				Tfa9887_Powerdown(atomic_read(&pd_called));
				msm_q6_disable_mi2s_clocks();
				}
			}
		}
		...
		struct kobj_attribute *attr, char *buf)
{
	...
	/* never modify the format of the printed string */
	sprintf(buf, "channel:%d\neq:%d", g_channel, eq_mode);
				      ...
				      const struct i2c_device_id *id)
{
	...
	if (regulator1 == NULL) {
	regulator1 = regulator_get(&i2c->dev, VDD_2P8);
	...
	if (regulator2 == NULL) {
	regulator2 = regulator_get(&i2c->dev, VDD_I2C);
	...
	ret = sysfs_create_file(tfa9887_kobj, (struct attribute *)&tfa9887_config);
	printk("tfa9887_add_sysfs ret=%d\n", ret);
	if (ret != 0) {
                dev_err(&i2c->dev, "Failed to add sysfs: %d\n", ret);
		goto err;
	}
	ret = sysfs_create_file(tfa9887_kobj, (struct attribute *)&tfa9887_cal);
	printk("tfa9887_add_sysfs ret=%d\n", ret);
	if (ret != 0) {
                dev_err(&i2c->dev, "Failed to add sysfs: %d\n", ret);
		goto err;
	}
	ret = sysfs_create_file(tfa9887_kobj, (struct attribute *)&tfa9887_vol);
	printk("tfa9887_add_sysfs ret=%d\n", ret);
	if (ret != 0) {
                dev_err(&i2c->dev, "Failed to add sysfs: %d\n", ret);
		goto err;
...
static __devexit int tfa9887R_i2c_remove(struct i2c_client *client)
{
	...
	regmap_exit(tfa9887R->regmap);
	sysfs_remove_file(tfa9887_kobj, (struct attribute *)&tfa9887_config);
	sysfs_remove_file(tfa9887_kobj, (struct attribute *)&tfa9887_cal);
	sysfs_remove_file(tfa9887_kobj, (struct attribute *)&tfa9887_vol);
