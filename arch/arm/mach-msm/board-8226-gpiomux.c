...
static struct gpiomux_setting gpio_leds_act_cfg = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_6MA,
	.pull = GPIOMUX_PULL_NONE,
...
static struct gpiomux_setting gpio_leds_sus_cfg = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_6MA,
	.pull = GPIOMUX_PULL_NONE,
	.dir = GPIOMUX_OUT_HIGH,
};
static struct msm_gpiomux_config gpio_leds_configs[] = {
	 {
                .gpio      = 22,
                .settings = {
                        [GPIOMUX_ACTIVE] = &gpio_leds_act_cfg,
                        [GPIOMUX_SUSPENDED] = &gpio_leds_sus_cfg,
                },
        },
};
...
static struct msm_gpiomux_config msm_blsp_spi0_configs[] __initdata = {
	{
...
static struct gpiomux_setting  ter_mi2s_act_cfg = {
	.func = GPIOMUX_FUNC_1,
	.drv = GPIOMUX_DRV_8MA,
	.pull = GPIOMUX_PULL_NONE,
};

static struct gpiomux_setting  ter_mi2s_sus_cfg = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_2MA,
	.pull = GPIOMUX_PULL_DOWN,
};

static struct msm_gpiomux_config msm8226_ter_mi2s_configs[] __initdata = {
	{
		.gpio	= 49,		/* qua mi2s sck */
		.settings = {
			[GPIOMUX_SUSPENDED] = &ter_mi2s_sus_cfg,
			[GPIOMUX_ACTIVE] = &ter_mi2s_act_cfg,
		},
	},
	{
		.gpio	= 50,
...
static struct gpiomux_setting  ydt_act_cfg = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_8MA,
	.pull = GPIOMUX_PULL_NONE,
};

static struct gpiomux_setting  ydt_sus_cfg = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_2MA,
	.pull = GPIOMUX_PULL_DOWN,
};

static struct msm_gpiomux_config msm8226_ydt_pa_configs[] __initdata = {
	{
		.gpio = 21,
		.settings = {
			[GPIOMUX_SUSPENDED] = &ydt_sus_cfg,
			[GPIOMUX_ACTIVE] = &ydt_act_cfg,
		},
	},
	{
		.gpio = 31,
...
static struct gpiomux_setting  us_eu_headset_act_cfg = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_8MA,
	.pull = GPIOMUX_PULL_NONE,
};

static struct gpiomux_setting  us_eu_headset_sus_cfg = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_2MA,
	.pull = GPIOMUX_PULL_DOWN,
};

static struct msm_gpiomux_config msm8226_us_eu_headset_configs[] __initdata = {
	{
		.gpio = 56,
		.settings = {
			[GPIOMUX_SUSPENDED] = &us_eu_headset_sus_cfg,
			[GPIOMUX_ACTIVE] = &us_eu_headset_act_cfg,
		},
	},
};
...
void __init msm8226_init_gpiomux(void)
{
	...
	if (board_is_bladefhd())
		msm_gpiomux_install(gpio_leds_configs, ARRAY_SIZE(gpio_leds_configs));
	else
		msm_gpiomux_install(msm_blsp_spi0_configs,
			ARRAY_SIZE(msm_blsp_spi0_configs));
	...
	if (board_is_bladefhd())
		msm_gpiomux_install(gpio_leds_configs, ARRAY_SIZE(gpio_leds_configs));
	msm_gpiomux_install(msm8226_ter_mi2s_configs,ARRAY_SIZE(msm8226_ter_mi2s_configs));

	msm_gpiomux_install(msm8226_ydt_pa_configs, ARRAY_SIZE(msm8226_ydt_pa_configs));

#ifdef CONFIG_SND_SOC_HEADSET_FSA8049
	msm_gpiomux_install(msm8226_us_eu_headset_configs, ARRAY_SIZE(msm8226_us_eu_headset_configs));
#endif
